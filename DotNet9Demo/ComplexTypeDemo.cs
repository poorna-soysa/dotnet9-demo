...
public static class ComplexTypesDemo
{
    ...
    public static Task GroupByComplexTypeDemoOnSqlite()
    ...
    public static async Task ExecuteQueries(bool sqlite)
    {
        ...
        context.AddRange(
            new Store
            {
                ...
                Region = "Germany",
                StoreAddress = new("L 123", null, "Berlin", "Germany", "12345")
            },
            ...
            new Customer
            {
                ...
                CustomerInfo = new("EF")
                {
                    HomeAddress = new("L2", null, "Ci2", "Co2", "P2"),
                    WorkAddress = new("L3", null, "Ci3", "Co3", "P3")
                },
            },
            new CustomerTpt
            {
                ...
                CustomerInfo = new("EF")
                {
                    HomeAddress = new("L5", null, "Ci5", "Co5", "P5"),
                    WorkAddress = new("L6", null, "Ci6", "Co6", "P6")
                },
            },
            new SpecialCustomerTpt
            {
                ...
                CustomerInfo = new("EF")
                {
                    HomeAddress = new("L7", null, "Ci7", "Co7", "P7"),
                    WorkAddress = new("L8", null, "Ci8", "Co8", "P8")
                }
            });
        ...
        Console.WriteLine();
        Console.WriteLine("GroupBy complex type results: ");
        Console.WriteLine();

        foreach (var groupedAddress in groupedAddresses)
        {
            Console.WriteLine($"{groupedAddress.Key.PostCode}" +
                $": {groupedAddress.Count}");
        }
